...
def steps(harness):
    ...
    harness.wait_for_visible(".card-cell", timeout=10_000)
    ...
    harness.wait_for_text("Unstoppable Slasher", timeout=10_000)
    ...
    harness.wait_for_text("Copies (1)", timeout=10_000)
