...
**YOU ARE IN: `deckdumpster/polecats/corpus/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/corpus
```
...
**Your mail address:** `deckdumpster/polecats/corpus`
...
1. Announce: "Polecat corpus, checking in."
2. Run: `gt prime`
