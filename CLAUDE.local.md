...
**YOU ARE IN: `deckdumpster/polecats/chumbucket/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/deckdumpster/` (rig root) or other directories

```bash
pwd  # Should show .../polecats/chumbucket
```
...
**Your mail address:** `deckdumpster/polecats/chumbucket`
**Your rig:** deckdumpster
**Your Witness:** `deckdumpster/witness`
...
1. Announce: "Polecat chumbucket, checking in."
2. Run: `gt prime`
...
| Ask Witness for help | `gt mail send deckdumpster/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`deckdumpster/witness`) when:
...
```bash
gt mail send deckdumpster/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
